        ...
        <div class="content_res">
            ...
            <div id="breadcrumb"><div id="crumbs">
                    <div class="breadcrumb-trail breadcrumbs" itemprop="breadcrumb"><span class="trail-begin"><a href="/" title="home" rel="home">Главная</a></span>
                        <span class="sep">/</span> <span class="trail-end"> <?=$type?></span>
                    </div></div></div>
            ...
            <div class="content_left">
                ...
                <div class="shadowblock_out">
                    ...
                    <div class="shadowblock">
                        ...
                        <h1 class="single dotted"><?=$type?> </h1>
                    ...
                    <div class="post-block-out featured">
                        ...
                        <div class="post-block">
                            ...
                            <div class="post-right full">
                                ...
                                <p class="post-meta">
                                    <span class="dashicons-before folder"><a href="" rel="tag"><?=$row['category']?> </a></span> <span class="dashicons-before owner"><a href="" title="Posts by <?=$row['user']['username'] ?>" rel="author"><?=$row['user']['username']?></a></span> <span class="dashicons-before clock"><span><?=date('d.m.Y', $row['created_at'])?></span></span>
                                </p>
